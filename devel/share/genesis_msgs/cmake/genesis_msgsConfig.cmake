...
if(NOT "/home/hmcl/shared_dir/mpc_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'genesis_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hmcl/shared_dir/mpc_ws/src/genesis_msgs/${idir}'.  ${_report}")
    endif()
