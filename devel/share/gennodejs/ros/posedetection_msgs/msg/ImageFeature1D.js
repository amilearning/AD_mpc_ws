...
class ImageFeature1D {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ImageFeature1D
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ImageFeature1D
    let len;
    let data = new ImageFeature1D(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ImageFeature1D(null);
