...
class KinMPCPathFollower(Controller):
	...
	def __init__(self, 
		        ...
		        #  L_R        = 1.4987, # distance from CoG to rear axle (m)
				 L_F        = 1.45, # distance from CoG to front axle (m)
		         L_R        = 1.45, # distance from CoG to rear axle (m)
		         ...
		         DF_DOT_MAX =  0.5, 
		         Q = [10., 10., 10., 0.1], # weights on x, y, psi, and v.
